...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Garden Keeper — Автополив у Одесі | Системи поливу з 2011" },
      { property: "og:description", content: "Монтаж автополиву, крапельного зрошення та рулонного газону в Одесі та області. 14 років досвіду. Hunter, Rain Bird." },
